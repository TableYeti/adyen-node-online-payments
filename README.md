...
>
> The fork is kept up to date with upstream. To see the minimal set of changes required for adaptation, [compare the branches](https://github.com/yetipay/adyen-node-online-payments/compare/main...yetipay:adyen-node-online-payments:yetipay) on GitHub.

This repository includes a collection of PCI-compliant UI integrations that show how to integrate with us using different payment methods.
...
|             [`In-person Payments Example`](in-person-payments-example) | NOT YET UPDATED FOR YETIPAY. In-person payments using a POS terminal and the terminal-api/sync endpoint. | [See below](#in-person-payments-example)       |
|                                [`Gift Card Example`](giftcard-example) | NOT YET UPDATED FOR YETIPAY. Gift Cards checkout flow using partial orders.                              | [See below](#gift-card-example)                |
|                             [`Pay by Link Example`](paybylink-example) | NOT YET UPDATED FOR YETIPAY. Pay by Link flow.                                                           | [See below](#pay-by-link-example)              |
|                         [`Subscription Example`](subscription-example) | NOT YET UPDATED FOR YETIPAY. Subscription flow using Adyen tokenization.                                 | [See below](#subscription-example)             |
|                                     [`Giving Example`](giving-example) | NOT YET UPDATED FOR YETIPAY. Donation flow using Adyen Giving.                                           | [See below](#giving-example)                   |

## [Checkout Example](checkout-example)

The [checkout example](checkout-example) repository includes examples of PCI-compliant UI integrations for online payments.
Within this demo app, you'll find a simplified version of an e-commerce website, complete with commented code to highlight key features and concepts of our API.
Check out the underlying code to see how you can integrate to give your shoppers the option to pay with their preferred payment methods, all in a seamless checkout experience.
